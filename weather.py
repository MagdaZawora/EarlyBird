...
def get_weather_forecast():
    r = requests.get('http://api.openweathermap.org/data/2.5/forecast?lat=41&lon=-76&units=metric&APPID={}')
    forecast = r.json()
    ...
    forecast_info += description + ' with pressure of ' + str(pressure) + ' hPa, a high of ' + str(int(temp_max)) + ' degrees'
